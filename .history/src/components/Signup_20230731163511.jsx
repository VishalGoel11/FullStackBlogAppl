  ...
  return (
    <div className="bg-[url('assets\heroBg.jpg')] bg-cover md:h-screen flex">
      <form className='p-52 '>
        ...
        <input type="text" className='bg-black text-white text-sm h-7 px-2' placeholder='Full name'/>
        <input type="text" className='bg-black text-white  text-sm h-7 px-2' placeholder='Email'/>
        <input type="text" className='bg-black text-white text-sm h-7 px-2' placeholder='Phone number'/>
