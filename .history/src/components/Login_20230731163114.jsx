  ...
  return (
    <div className="bg-[url('assets\heroBg.jpg')] bg-cover md:h-screen flex">
      <form className='p-56 '>
        ...
        <input type="text" className='bg-black text-white text-sm h-7' placeholder='Email'/>
        <input type="text" className='bg-black text-white  text-sm h-7 p' placeholder='Password'/>
        </div>
