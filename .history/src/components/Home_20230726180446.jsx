...
const Home = () => {
  return (
    <div className ="bg-[url('assets\heroBg.jpg')] bg-cover">
        <div className='flex flex-col justify-between p-8 md:mx-8 place-items-center'>
            <div className='w-52'>
              <img src= {Logo} alt=""  />
            </div>
        ...
        <div className='md:flex md:justify-around'>
          <div className='text-center mt-10 mx-10 md:w-1/2 md:text-left md:my-24'>
            ...
            <p className='mt-5 text-greay-500'>Discover insightful articles and stay informed on various topics. Engage, learn, and grow with us!</p>
          </div>
