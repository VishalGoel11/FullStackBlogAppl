  ...
  return (
    <div className ="bg-[url('assets\heroBg.jpg')] bg-cover ">
        ...
        <div className='md:flex md:justify-around'>
          <div className='text-center mt-10 mx-10 md:w-1/2 md:text-left'>
            <h1 className='text-4xl md:text-5xl font-bold md:mx-10 '>Ink & Imagination:<br/> Where Creativity Knows No Bounds</h1>
          ...
          <div className='bg-white md:w-2/5 m-10 text-black rounded-md py-10'>
            <div className='text-center '>
              ...
              <p>Don't have an account?<br/><span className='underline'>Create one!</span></p>
              {/* <div className='bg-black w-20 h-2 '> .</div> */}
            </div>
              <div className='grid justify-center gap-y-5 py-10'>
                <div className='flex justify-around'>
                  <FontAwesomeIcon icon={faUser} />
                  <input type="text" className='border-b-2 border-black w-4/5' placeholder='Username' />
                </div>
                <div className='flex justify-around'>
                  <FontAwesomeIcon icon={faLock} />
                  <input type="text" className='border-b-2 border-black w-4/5' placeholder='Password'/>
                </div>
              </div>
