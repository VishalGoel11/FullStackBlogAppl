    ...
    <div className ="bg-[url('assets\heroBg.jpg')] bg-cover ">
        ...
        <div className='md:flex md:justify-around'>
          <div className='text-center mt-20 '>
            <h1 className='text-3xl md:text-5xl font-bold'>Curious Minds <br></br> Unraveling the Mysteries of Science</h1>
            <p className='mt-10'>Create a unique and beautiful blog easily.</p>
          </div>
