  ...
  return (
    <div className ="bg-[url('assets\heroBg.jpg')] bg-cover ">
        ...
        <div className='md:flex md:justify-around'>
          <div className='text-center md:mt-20 mx-10'>
            <h1 className='text-3xl md:text-5xl font-bold'>Curious Minds <br/> Unraveling the Mysteries of Science</h1>
            <p className='mt-10'>Discover insightful articles and stay informed on various topics at our blog website. Engage, learn, and grow with us!</p>
          </div>
