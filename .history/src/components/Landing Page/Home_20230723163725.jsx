  ...
  return (
    <div className ="bg-[url('assets\heroBg.jpg')] bg-cover ">
        ...
        <div className='md:flex md:justify-around'>
          <div className='text-center mt-10 mx-10 md:w-1/2'>
            <h1 className='text-4xl md:text-5xl font-bold md:text-left'>Ink & Imagination:<br/> Where Creativity Knows No Bounds</h1>
