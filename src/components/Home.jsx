  ...
  return (
    <div className =" bg-[url('assets\heroBg.jpg')] bg-cover md:h-screen pt-10">
        ...
        <div className='md:flex md:mx-10'>
          <div className='text-center mt-5 mx-10  md:text-left md:my-24'>
            <h1 className='text-4xl md:text-5xl font-bold  '>Ink & Imagination:<br/> Where Creativity Knows No Bounds</h1>
            <p className='mt-2 text-gray-100'>Discover insightful articles and stay informed on various topics. Engage, learn, and grow with us!</p>
            <div className='cursor-pointer list-none p-2 gap-x-2  md:gap-10' >
             <a href="www.google.com" target='_blank'><li className='border-2 px-2 py-1 w-24 mt-3 text-center'>Connect</li></a>
            </div>
          </div>
